...
const wholeStar = (
  <svg width="100" height="100">
    <polygon points="50,9 60.5,39.5 92.7,40.1 67,59.5 76.4,90.3 50,71.9 23.6,90.3 32.9,59.5 7.2,40.1 39.4,39.5" stroke="black" strokeWidth="5" fill="gold" />
  </svg>
);
const quarterStar = (
  <svg width="100" height="100">
...
const threeQuarterStar = (
  <svg width="100" height="100">
    ...
    <defs>
      <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="0%">
        <stop offset="67%" stopColor="gold" stopOpacity="1" />
